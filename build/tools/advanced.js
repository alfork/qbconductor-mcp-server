...
export const passthroughRequestTool = {
...
export const passthroughRequestHandler = withErrorHandling(async (input) => {
...
export const bulkOperationsHandler = withErrorHandling(async (input) => {
