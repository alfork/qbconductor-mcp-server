...
import { CreateEndUserSchema } from '../schemas/mcp-schemas.js';
import { z } from 'zod';
export const createEndUserTool = {
...
export const deleteEndUserTool = {
...
export const createEndUserHandler = withErrorHandling(async (input) => {
...
export const listEndUsersHandler = withErrorHandling(async (input) => {
...
export const getEndUserHandler = withErrorHandling(async (input) => {
    const params = validateInput(z.object({
        endUserId: z.string(),
    }), input);
    const client = new ConductorClient();
...
export const deleteEndUserHandler = withErrorHandling(async (input) => {
    const params = validateInput(z.object({
        endUserId: z.string(),
    }), input);
    const client = new ConductorClient();
