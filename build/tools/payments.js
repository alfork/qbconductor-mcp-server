...
import { formatSuccessResponse, formatPaginatedResponse } from '../utils/formatting.js';
import { withErrorHandling } from '../utils/error-handling.js';
import { ListBillPaymentsSchema, CreateBillPaymentSchema, UpdateBillPaymentSchema, DeleteBillPaymentSchema } from '../schemas/mcp-schemas.js';
export const listBillCheckPaymentsTool = {
...
export const listBillCreditCardPaymentsTool = {
...
export const createBillCheckPaymentTool = {
...
export const createBillCreditCardPaymentTool = {
...
export const listBillCheckPaymentsHandler = withErrorHandling(async (input) => {
    ...
    if (params.payeeId)
        queryParams.payeeId = params.payeeId;
    if (params.accountId)
...
export const listBillCreditCardPaymentsHandler = withErrorHandling(async (input) => {
    const params = validateInput(ListBillPaymentsSchema.extend({
...
export const createBillCheckPaymentHandler = withErrorHandling(async (input) => {
...
export const createBillCreditCardPaymentHandler = withErrorHandling(async (input) => {
    const params = validateInput(CreateBillPaymentSchema.extend({
...
export const updatePaymentHandler = withErrorHandling(async (input) => {
    ...
    if (params.appliedToBills)
        updateData.appliedToBills = params.appliedToBills;
...
export const deletePaymentHandler = withErrorHandling(async (input) => {
