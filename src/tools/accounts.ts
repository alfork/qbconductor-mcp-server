...
export const listAccountsHandler = withErrorHandling(async (input: unknown) => {
  ...
  if (params.nameContains) queryParams.name = params.nameContains;
...
export const getAccountHandler = withErrorHandling(async (input: unknown) => {
...
export const createAccountHandler = withErrorHandling(async (input: unknown) => {
...
export const updateAccountHandler = withErrorHandling(async (input: unknown) => {
  ...
  if (params.accountNumber !== undefined) updateData.accountNumber = params.accountNumber;
