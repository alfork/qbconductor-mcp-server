...
export const createAuthSessionTool: Tool = {
...
export const createAuthSessionHandler = withErrorHandling(async (input: unknown) => {
...
export const checkConnectionStatusHandler = withErrorHandling(async (input: unknown) => {
