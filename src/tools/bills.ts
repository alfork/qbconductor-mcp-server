...
export const listBillsTool: Tool = {
  name: 'list_bills',
...
export const createBillTool: Tool = {
  name: 'create_bill',
...
export const updateBillTool: Tool = {
  name: 'update_bill',
...
export const listBillsHandler = withErrorHandling(async (input: unknown) => {
...
export const getBillHandler = withErrorHandling(async (input: unknown) => {
...
export const updateBillHandler = withErrorHandling(async (input: unknown) => {
  ...
  if (params.vendorId) updateData.vendorId = params.vendorId;
  if (params.transactionDate) updateData.transactionDate = params.transactionDate;
  ...
  if (params.lines) updateData.lines = params.lines;
